...
Source Database       : nms_db

Target Server Type    : MYSQL
Target Server Version : 50629
File Encoding         : 65001

Date: 2016-11-30 17:15:13
*/
...
INSERT INTO `area_info` VALUES ('1003', '411329', '新野县', '3', '411300', null, '1');
...
CREATE TABLE `data_dictionary` (
  ...
  `order_number` int(2) unsigned zerofill NOT NULL,
  `remark` varchar(1000) DEFAULT '',
  `enable` tinyint(1) unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `date_dictionary_type_unique` (`dictionary_type`) USING BTREE
