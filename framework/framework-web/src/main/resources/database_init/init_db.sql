...
CREATE TABLE DATA_DICTIONARY (
  ...
  ENABLE NUMBER(2) DEFAULT 1 NOT NULL ,
  PRIMARY KEY (ID)
);
...
-- ----------------------------
INSERT INTO DATA_DICTIONARY VALUES ('1', '0', '1', '根节点', 'ROOT', '0', '0', null, '1', '1');
...
CREATE TABLE VERSION_INFO (
  ...
  VERSION_NO VARCHAR2(60 BYTE) NULL ,
  VERSION_CONTENT VARCHAR2(4000 BYTE) NULL ,
  NAME VARCHAR2(80 BYTE) NULL ,
  SYSTEM_NAME VARCHAR2(80 BYTE) NULL ,
  REPORT_DATE DATE NULL ,
  GENERAL_NO VARCHAR2(20 BYTE) NULL ,
  FIRST_REPORT_DATE DATE NULL ,
  IS_VISIBLE NUMBER(1) DEFAULT 1  NULL ,
  DISPLAY_LABEL VARCHAR2(40 BYTE) NULL ,
  PUBLISH_DATE VARCHAR2(30 BYTE) NULL ,
PRIMARY KEY (ID)
)
  PCTFREE 10
  INITRANS 1
...
COMMENT ON TABLE VERSION_INFO IS '版本信息表';

COMMENT ON COLUMN VERSION_INFO.ID IS '主键';

COMMENT ON COLUMN VERSION_INFO.VERSION_NO IS '版本号';

COMMENT ON COLUMN VERSION_INFO.VERSION_CONTENT IS '版本内容';

COMMENT ON COLUMN VERSION_INFO.NAME IS '组件名称';

COMMENT ON COLUMN VERSION_INFO.SYSTEM_NAME IS '子系统名称';

COMMENT ON COLUMN VERSION_INFO.REPORT_DATE IS '版本上报时间';

COMMENT ON COLUMN VERSION_INFO.GENERAL_NO IS '总版本号';

COMMENT ON COLUMN VERSION_INFO.FIRST_REPORT_DATE IS '首次上报时间';

COMMENT ON COLUMN VERSION_INFO.IS_VISIBLE IS '是否展示';

COMMENT ON COLUMN VERSION_INFO.DISPLAY_LABEL IS '页面展示label';
